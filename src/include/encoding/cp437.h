 ...
 * @brief Dicop Project - Character encoding tables for CP437
 *  
 * @english
 *
...
#ifndef DICOP_CP437_H
#define DICOP_CP437_H

/** Table to convert Unicode to CP437 */
unsigned long encoding_cp437[237] = {
  118,
  ...
  1, 0xdc, 2, 0xa2, 1, 0xa5, 1, 0x20a7, 1, 0x192, 1, 0xe1, 1, 0xed, 1, 0xf3, 
  1, 0xfa, 1, 0xf1, 1, 0xd1, 1, 0xaa, 1, 0xba, 1, 0xbf, 1, 0x2310, 1, 0xac, 1, 0xbd, 
  1, 0xbc, 1, 0xa1, 1, 0xab, 1, 0xbb, 3, 0x2591, 1, 0x2502, 1, 0x2524, 2, 0x2561, 
...
/** Table to convert CP437 to UTF-8 */
unsigned long enc_cp437[257] = {
  ...
  0xbbc3, 0xb9c3, 0xbfc3, 0x96c3, 0x9cc3, 0xa2c2, 0xa3c2, 0xa5c2, 0xa782e2, 0x92c6, 
...
/** Table to convert CP437 to Unicode codepoints */
unsigned long cp_cp437[256] = {
...
unsigned char uc_cp437[256] = {
  ...
  0x8f, 0x90, 0x92, 0x92, 0x3f, 0x99, 0x3f, 0x3f, 0x3f, 0x3f, 0x99, 0x9a, 0x9b, 
