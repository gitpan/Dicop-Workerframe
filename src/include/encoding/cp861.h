 ...
 * @brief Dicop Project - Character encoding tables for CP861
 *  
 * @english
 *
...
#ifndef DICOP_CP861_H
#define DICOP_CP861_H

/** Table to convert Unicode to CP861 */
unsigned long encoding_cp861[239] = {
  119,
  128, 0x0, 1, 0xc7, 1, 0xfc, 1, 0xe9, 1, 0xe2, 1, 0xe4, 1, 0xe0, 
  1, 0xe5, 1, 0xe7, 2, 0xea, 1, 0xe8, 1, 0xd0, 1, 0xf0, 1, 0xde, 2, 0xc4, 1, 0xc9, 
  1, 0xe6, 1, 0xc6, 1, 0xf4, 1, 0xf6, 1, 0xfe, 1, 0xfb, 1, 0xdd, 1, 0xfd, 1, 0xd6, 
  1, 0xdc, 1, 0xf8, 1, 0xa3, 1, 0xd8, 1, 0x20a7, 1, 0x192, 1, 0xe1, 1, 0xed, 
  1, 0xf3, 1, 0xfa, 1, 0xc1, 1, 0xcd, 1, 0xd3, 1, 0xda, 1, 0xbf, 1, 0x2310, 1, 0xac, 
  1, 0xbd, 1, 0xbc, 1, 0xa1, 1, 0xab, 1, 0xbb, 3, 0x2591, 1, 0x2502, 1, 0x2524, 
  2, 0x2561, 1, 0x2556, 1, 0x2555, 1, 0x2563, 1, 0x2551, 1, 0x2557, 1, 0x255d, 
  1, 0x255c, 1, 0x255b, 1, 0x2510, 1, 0x2514, 1, 0x2534, 1, 0x252c, 1, 0x251c, 
  1, 0x2500, 1, 0x253c, 2, 0x255e, 1, 0x255a, 1, 0x2554, 1, 0x2569, 1, 0x2566, 
  1, 0x2560, 1, 0x2550, 1, 0x256c, 2, 0x2567, 2, 0x2564, 1, 0x2559, 1, 0x2558, 
  2, 0x2552, 1, 0x256b, 1, 0x256a, 1, 0x2518, 1, 0x250c, 1, 0x2588, 1, 0x2584, 
  1, 0x258c, 1, 0x2590, 1, 0x2580, 1, 0x3b1, 1, 0xdf, 1, 0x393, 1, 0x3c0, 1, 0x3a3, 
  1, 0x3c3, 1, 0xb5, 1, 0x3c4, 1, 0x3a6, 1, 0x398, 1, 0x3a9, 1, 0x3b4, 1, 0x221e, 
  1, 0x3c6, 1, 0x3b5, 1, 0x2229, 1, 0x2261, 1, 0xb1, 1, 0x2265, 1, 0x2264, 2, 0x2320, 
  1, 0xf7, 1, 0x2248, 1, 0xb0, 1, 0x2219, 1, 0xb7, 1, 0x221a, 1, 0x207f, 1, 0xb2, 
  1, 0x25a0, 1, 0xa0
  };

/** Table to convert CP861 to UTF-8 */
unsigned long enc_cp861[257] = {
  ...
  0xa9c3, 0xa2c3, 0xa4c3, 0xa0c3, 0xa5c3, 0xa7c3, 0xaac3, 0xabc3, 0xa8c3, 0x90c3, 
  0xb0c3, 0x9ec3, 0x84c3, 0x85c3, 0x89c3, 0xa6c3, 0x86c3, 0xb4c3, 0xb6c3, 0xbec3, 
  0xbbc3, 0x9dc3, 0xbdc3, 0x96c3, 0x9cc3, 0xb8c3, 0xa3c2, 0x98c3, 0xa782e2, 0x92c6, 
  0xa1c3, 0xadc3, 0xb3c3, 0xbac3, 0x81c3, 0x8dc3, 0x93c3, 0x9ac3, 0xbfc2, 0x908ce2, 
...
/** Table to convert CP861 to Unicode codepoints */
unsigned long cp_cp861[256] = {
  ...
  252, 233, 226, 228, 224, 229, 231, 234, 235, 232, 208, 240, 222, 196, 197, 
  201, 230, 198, 244, 246, 254, 251, 221, 253, 214, 220, 248, 163, 216, 8359, 
  402, 225, 237, 243, 250, 193, 205, 211, 218, 191, 8976, 172, 189, 188, 161, 
...
unsigned char uc_cp861[256] = {
  ...
  0x90, 0x3f, 0x8e, 0x3f, 0x8f, 0x80, 0x3f, 0x3f, 0x3f, 0x8b, 0x8b, 0x8d, 0x8e, 
  0x8f, 0x90, 0x92, 0x92, 0x3f, 0x99, 0x8d, 0x3f, 0x97, 0x97, 0x99, 0x9a, 0x9d, 
  0x9c, 0x9d, 0x9e, 0x3f, 0xa4, 0xa5, 0xa6, 0xa7, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 
...
unsigned char lc_cp861[256] = {
  ...
  0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88, 0x89, 0x8a, 0x8c, 0x8c, 0x95, 0x84, 
  0x86, 0x82, 0x91, 0x91, 0x93, 0x94, 0x95, 0x96, 0x98, 0x98, 0x94, 0x81, 0x9b, 
  0x9c, 0x9b, 0x9e, 0x9f, 0xa0, 0xa1, 0xa2, 0xa3, 0xa0, 0xa1, 0xa2, 0xa3, 0xa8, 
  0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 
  0xb6, 0xb7, 0xb8, 0xb9, 0xba, 0xbb, 0xbc, 0xbd, 0xbe, 0xbf, 0xc0, 0xc1, 0xc2, 
  0xc3, 0xc4, 0xc5, 0xc6, 0xc7, 0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf, 
  0xd0, 0xd1, 0xd2, 0xd3, 0xd4, 0xd5, 0xd6, 0xd7, 0xd8, 0xd9, 0xda, 0xdb, 0xdc, 
