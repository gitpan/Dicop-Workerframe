 ...
 * @brief Dicop Project - Character encoding tables for CP860
 *  
 * @english
 *
...
#ifndef DICOP_CP860_H
#define DICOP_CP860_H

/** Table to convert Unicode to CP860 */
unsigned long encoding_cp860[237] = {
  118,
  128, 0x0, 1, 0xc7, 1, 0xfc, 1, 0xe9, 2, 0xe2, 1, 0xe0, 1, 0xc1, 
  1, 0xe7, 1, 0xea, 1, 0xca, 1, 0xe8, 1, 0xcd, 1, 0xd4, 1, 0xec, 1, 0xc3, 1, 0xc2, 
  1, 0xc9, 1, 0xc0, 1, 0xc8, 2, 0xf4, 1, 0xf2, 1, 0xda, 1, 0xf9, 1, 0xcc, 1, 0xd5, 
  1, 0xdc, 2, 0xa2, 1, 0xd9, 1, 0x20a7, 1, 0xd3, 1, 0xe1, 1, 0xed, 1, 0xf3, 1, 0xfa, 
  1, 0xf1, 1, 0xd1, 1, 0xaa, 1, 0xba, 1, 0xbf, 1, 0xd2, 1, 0xac, 1, 0xbd, 1, 0xbc, 
  1, 0xa1, 1, 0xab, 1, 0xbb, 3, 0x2591, 1, 0x2502, 1, 0x2524, 2, 0x2561, 1, 0x2556, 
  1, 0x2555, 1, 0x2563, 1, 0x2551, 1, 0x2557, 1, 0x255d, 1, 0x255c, 1, 0x255b, 
  1, 0x2510, 1, 0x2514, 1, 0x2534, 1, 0x252c, 1, 0x251c, 1, 0x2500, 1, 0x253c, 
  2, 0x255e, 1, 0x255a, 1, 0x2554, 1, 0x2569, 1, 0x2566, 1, 0x2560, 1, 0x2550, 
  1, 0x256c, 2, 0x2567, 2, 0x2564, 1, 0x2559, 1, 0x2558, 2, 0x2552, 1, 0x256b, 
  1, 0x256a, 1, 0x2518, 1, 0x250c, 1, 0x2588, 1, 0x2584, 1, 0x258c, 1, 0x2590, 
  1, 0x2580, 1, 0x3b1, 1, 0xdf, 1, 0x393, 1, 0x3c0, 1, 0x3a3, 1, 0x3c3, 1, 0xb5, 
  1, 0x3c4, 1, 0x3a6, 1, 0x398, 1, 0x3a9, 1, 0x3b4, 1, 0x221e, 1, 0x3c6, 1, 0x3b5, 
  1, 0x2229, 1, 0x2261, 1, 0xb1, 1, 0x2265, 1, 0x2264, 2, 0x2320, 1, 0xf7, 1, 0x2248, 
  1, 0xb0, 1, 0x2219, 1, 0xb7, 1, 0x221a, 1, 0x207f, 1, 0xb2, 1, 0x25a0, 1, 0xa0
  };

/** Table to convert CP860 to UTF-8 */
unsigned long enc_cp860[257] = {
  ...
  0xa9c3, 0xa2c3, 0xa3c3, 0xa0c3, 0x81c3, 0xa7c3, 0xaac3, 0x8ac3, 0xa8c3, 0x8dc3, 
  0x94c3, 0xacc3, 0x83c3, 0x82c3, 0x89c3, 0x80c3, 0x88c3, 0xb4c3, 0xb5c3, 0xb2c3, 
  0x9ac3, 0xb9c3, 0x8cc3, 0x95c3, 0x9cc3, 0xa2c2, 0xa3c2, 0x99c3, 0xa782e2, 0x93c3, 
  0xa1c3, 0xadc3, 0xb3c3, 0xbac3, 0xb1c3, 0x91c3, 0xaac2, 0xbac2, 0xbfc2, 0x92c3, 
...
/** Table to convert CP860 to Unicode codepoints */
unsigned long cp_cp860[256] = {
  ...
  252, 233, 226, 227, 224, 193, 231, 234, 202, 232, 205, 212, 236, 195, 194, 
  201, 192, 200, 244, 245, 242, 218, 249, 204, 213, 220, 162, 163, 217, 8359, 
  211, 225, 237, 243, 250, 241, 209, 170, 186, 191, 210, 172, 189, 188, 161, 
...
unsigned char uc_cp860[256] = {
  ...
  0x90, 0x8f, 0x8e, 0x91, 0x86, 0x80, 0x89, 0x89, 0x92, 0x8b, 0x8c, 0x98, 0x8e, 
  0x8f, 0x90, 0x91, 0x92, 0x8c, 0x99, 0xa9, 0x96, 0x9d, 0x98, 0x99, 0x9a, 0x9b, 
  0x9c, 0x9d, 0x9e, 0x9f, 0x86, 0x8b, 0x9f, 0x96, 0xa5, 0xa5, 0xa6, 0xa7, 0xa8, 
...
unsigned char lc_cp860[256] = {
  ...
  0x82, 0x83, 0x84, 0x85, 0xa0, 0x87, 0x88, 0x88, 0x8a, 0xa1, 0x93, 0x8d, 0x84, 
  0x83, 0x82, 0x85, 0x8a, 0x93, 0x94, 0x95, 0xa3, 0x97, 0x8d, 0x94, 0x81, 0x9b, 
  0x9c, 0x97, 0x9e, 0xa2, 0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa4, 0xa6, 0xa7, 0xa8, 
  0x95, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 
  0xb6, 0xb7, 0xb8, 0xb9, 0xba, 0xbb, 0xbc, 0xbd, 0xbe, 0xbf, 0xc0, 0xc1, 0xc2, 
  0xc3, 0xc4, 0xc5, 0xc6, 0xc7, 0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf, 
  0xd0, 0xd1, 0xd2, 0xd3, 0xd4, 0xd5, 0xd6, 0xd7, 0xd8, 0xd9, 0xda, 0xdb, 0xdc, 
